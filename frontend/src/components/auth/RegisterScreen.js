...
import { login, register } from '../../apiRequest/actions/userActions';
  ...
  <div className="container py-5 h-100" style={myStyle}>
    <div className="row d-flex justify-content-center align-items-center">
      <div className="col-12 col-md-8 col-lg-6 col-xl-5">
        <div className="bg-dark text-white" style={{borderRadius: "1rem"}}>
          <div className="card-body p-5 text-center">

            <div className="mb-md-5 mt-md-4 pb-5">

              <h2 className="fw-bold mb-2 text-uppercase">Register</h2>
              <p className="text-white-50 mb-5">Please fill out the following information form.</p>
              ...
              <Form.Group controlId='selectBox' className='form-outline mb-4'>
                <Form.Select 
                  className="form-control form-control-lg"
                  value={isRealtor.toString()} 
                  onChange={(e) => setIsRealtor(e.target.value === 'true')}
                >
            ...
            <div className="mb-4 form-check" >
                ...
                I agree to the <a href="#!" style={{color: 'yellow'}}>Terms and Conditions</a> and <a href="#!" style={{color: 'yellow'}}>Privacy Policy</a>.
                </label>
            </div>
            ...
            <div>
              <p className="mb-0">You have account yet? <a href='/login' className="text-white-50 fw-bold">Sign In Here</a>
              </p>
            </div>

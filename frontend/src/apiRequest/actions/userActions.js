...
export const register = (name, email, password, rePassword, isRealtor) => async (dispatch) => {
    try{
        dispatch({
        ...
        const {data} = await axios.post(
            'auth/user/register',
            {"name": name, "email": email, "password": password,"re_password": rePassword, "is_realtor": isRealtor},
            config
        )
        dispatch({
